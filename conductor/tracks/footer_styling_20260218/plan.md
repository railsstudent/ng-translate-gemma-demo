...
- [ ] **Task 1: Generate Footer Component**
    ...
    - [ ] Set `standalone: true` and `changeDetection: ChangeDetectionStrategy.OnPush`.
...
- [ ] **Task 3: Implement Footer Template & Styling**
    ...
    - [ ] Add the GitHub icon (using a simple SVG or FontAwesome if available).
